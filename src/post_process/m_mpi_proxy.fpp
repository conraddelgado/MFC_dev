...
contains
    ...
    subroutine s_mpi_bcast_user_inputs
        ...
        #:for VAR in [ 'cyl_coord', 'mpp_lim', 'mixture_err',                  &
            ...
            & 'surface_tension', 'hyperelasticity', 'bubbles_lagrange', 'rkck_adap_dt', 'output_partial_domain', 'q_filtered_wrt', 'pencil_domain_decomposition', 'slab_domain_decomposition' ]
    ...
    subroutine s_mpi_sendrecv_cons_vars_buffer_regions(q_cons_vf, pbc_loc, &
                                                       sweep_coord, q_particle, mag_div_Ru, mag_div_R_mu, mag_F_IMET)
